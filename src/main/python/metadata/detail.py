...
class Detail:
    ...
    def detail_beijing_beijing(self, curl):
        ...
        information = soup.find('div', attrs={
            "id": "zydtCont1"
        }).find('div', attrs={"class": "sjdetails_cardmain_frame"})
        pattern = '(.+)[ ：\t](.+)'
    ...
    def detail_shanxi_changzhi(self, curl):
        ...
        if soup.find('li', attrs={'action': 'data-download'}) is not None:
            for item in soup.find('li', attrs={
    ...
    def detail_shanxi_jincheng(self, curl):
        ...
        dataset_metadata['资源摘要'] = soup.find('div', attrs={
            'class': 'dl-part'
        }).find('p', attrs={
            'class': 'dl-part-text'
        }).get_text().strip()
    ...
    def detail_shanxi_yuncheng(self, curl):
        ...
        tr_text = []
        for td in table_div.find('table', attrs={
    ...
    def detail_sichuan_bazhong(self, curl):
        ...
        list_table = [
            'resourceName', 'dataSource', 'industryCategory', 'publishTime', 'updateTime', 'openType', 'dataVolume',
            'industryField', 'dataUpdatePeriod', 'departmentContactTel', 'email', 'remark', 'resourceType'
        ]
        dataset_matadata = {}
    ...
    def detail_sichuan_aba(self, curl):
        ...
        list_table = [
            'subjectBaseName', 'orgName', 'fieldName', 'releaseTime', 'updateTime', 'openTypeName', 'dataNumSum',
            'industry', 'frequency', 'orgPhone', 'orgEmail', 'label', 'tableRemark', 'dataType'
        ]
        dataset_matadata = {}
